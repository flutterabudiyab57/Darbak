...
// import '../../../cash_back/screen/widgets/cashback_reward.dart';
...
//
// class CarsMonthlyInfo extends StatefulWidget {
//   CarsMonthlyInfo({
//     Key? key,
//     required this.datum,
//     this.filterModel,
...
//
//   @override
//   State<CarsMonthlyInfo> createState() => _CarsMonthlyInfoState();
// }
//
// class _CarsMonthlyInfoState extends State<CarsMonthlyInfo> {
...
//                   Column(
//                     children: [
//                       if (widget.stockStatus != null) SizedBox(height: 30.h),
//                       CarImageCarousel(
...
//                                             style: AppTypography.headingColor12(
//                                                 context),
//                                           ),
//                                         ),
//                                         Flexible(
...
//                                 Text.rich(
//                                   TextSpan(
//                                     text: "${widget.datum!.priceAfter1Month} ",
//                                     style: TextStyle(
//                                       fontSize: 20.sp,
...
//                                 ),
//                                 Text(
//                                   "/${locale.isDirectionRTL(context) ? "شهر" : "month"}",
//                                   style:
...
//                       text2:
//                           "${locale.isDirectionRTL(context) ? 'مقاعد' : 'Seats'}",
...
//                           ? "السرعة القصوي"
//                           : "Maximum speed",
//                       text: "${widget.datum!.kilo} ",
//                       text2:
//                           "${locale.isDirectionRTL(context) ? 'كم/يوم' : 'KM/day'}",
//                       backgroundColor: Color(0xffDBEDE6),
//                     ),
//                     CarIconInfo(
//                       image: Assets.icon_fuelPump,
//                       description:
//                           locale.isDirectionRTL(context) ? 'الوقود' : 'PETROL',
//                       text: "${widget.datum!.fuel} ",
...
//                                 : "Stock status is not available. Enjoy another experience.",
...
//                                   style:
//                                       AppTypography.paragraphColor15(context),
//                                 ),
//                               ),
//                               actions: [
...
//                                           )
//                                               : ADGradientButton(
//                                                   locale.ok.toString(), width: MediaQuery.of(context).size.width *0.4,
