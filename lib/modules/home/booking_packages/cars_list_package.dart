...
import 'package:darbak/modules/home/booking_packages/car_daily_backage.dart';
...
class _CarsListPackageState extends State<CarsListPackage> with TickerProviderStateMixin {
  late int pageNumber;
  ...
  Widget build(BuildContext context) {
    // final size = MediaQuery.of(context).size;ٍ
    final locale = AppLocalizations.of(context)!;
    return Scaffold(
